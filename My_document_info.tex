...
\title{Proposal: \\
Enhanced Mapping and Navigation of a Unmanned Ground Vehicle using Capacitive Proximity and Tactile Sensors}
\titleotherlanguage{Verbesserte Kartierung und Navigation eines Unbemanntes Landfahrzeuges mithilfe Kapazitiver Näherungs- und Berührungssensoren}

\author{Alexander Möhring}
\address{Rastatterstraße 20}
\city{76571 Gaggenau}
\email{alexander.moehring@student.kit.edu}
